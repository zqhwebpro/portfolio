<?php
/**
 * EST 1974 // Little Italy Pizzeria & Ristorante
...
<head>
  ...
  <!-- Italian Pizzeria Design System CSS -->
...
<body>
  ...
  <main id="view-menu-selection" class="app-view active app-container">
    ...
    <section class="hero-blackboard">
      <div class="hero-content">
        <div>
          ...
          <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
            <button class="hero-cta-btn" onclick="document.getElementById('menu-slate-section').scrollIntoView({ behavior: 'smooth' })">
    ...
    <!-- 4 Curved Red Dome Feature Cards -->
    <section class="category-feature-grid">
      <div class="category-feature-card">
        <div class="category-card-top-red">
          <h3 class="category-card-title">Pizzas</h3>
          <span class="category-see-menu-pill">Wood-Fired</span>
        </div>
      ...
      <div class="category-feature-card">
        <div class="category-card-top-red">
          ...
          <span class="category-see-menu-pill">Fresh Baked</span>
        </div>
      ...
      <div class="category-feature-card">
        <div class="category-card-top-red">
          ...
          <span class="category-see-menu-pill">Stuffed</span>
        </div>
      ...
      <div class="category-feature-card">
        <div class="category-card-top-red">
          ...
          <span class="category-see-menu-pill">Artisan</span>
        </div>
    ...
    <!-- App Menu Section (With Slate Background) -->
    <section id="menu-slate-section" class="menu-slate-container">
    ...
    <!-- Bottom Sticky Order Dispatcher Bar (Off-White Styling with SUBMIT ORDER Button) -->
    <div id="bottom-order-bar" class="bottom-order-bar">
      <div class="order-bar-inner">
        <div class="order-bar-summary">
          ...
          <div>
            <span id="order-bar-ready-time" style="font-family: var(--font-mono); font-size: 0.85rem; color: var(--pizza-red); font-weight: 800; margin-right: 0.75rem;">
              Ready in ~18 mins
            </span>
            <span style="font-family: var(--font-mono); font-size: 1.25rem; font-weight: 900; color: var(--text-dark);" id="order-bar-total-price">
              $34.00
            </span>
          </div>
        </div>
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem;">
          <div style="display: inline-flex; background: rgba(0, 0, 0, 0.06); border-radius: var(--radius-pill); padding: 2px;">
            <button id="pickup-btn-shelf" onclick="window.setPickupMethod('shelf')" class="filter-pill-btn active" style="padding: 0.35rem 0.75rem; font-size: 0.72rem; background: var(--mozzarella-yellow); color: #14171C; border: none; border-radius: var(--radius-pill);">
              📦 Store Shelf
            </button>
            <button id="pickup-btn-curbside" onclick="window.setPickupMethod('curbside')" class="filter-pill-btn" style="padding: 0.35rem 0.75rem; font-size: 0.72rem; background: transparent; color: var(--text-dark); border: none; border-radius: var(--radius-pill);">
              🚗 Curbside
            </button>
          </div>
  ...
  <main id="view-order-tracker" class="app-view app-container">
    <div class="tracker-full-view">
      ...
      <section class="tracker-hero-card">
        ...
        <div class="tracker-header-strip">
          <div>
            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.35rem; flex-wrap: wrap;">
              ...
              <span id="tracker-placed-timestamp" style="font-family: var(--font-mono); font-size: 0.76rem; color: var(--text-muted); font-weight: 700;">
                Fired at 07:45 PM
              </span>
              <span class="badge" style="background: var(--basil-green-light); color: var(--basil-green-dark); font-family: var(--font-mono); font-size: 0.72rem; font-weight: 800; padding: 0.25rem 0.65rem; border-radius: var(--radius-pill);">
                <span class="live-dot-pulse" style="margin-right: 3px;"></span> HEARTH ACTIVE
              </span>
            </div>
            <h2 id="tracker-stage-title-heading" class="tracker-title">
              Impasto Tossed &amp; Hand-Stretched
            </h2>
            <p id="tracker-stage-description-p" style="font-size: 0.95rem; color: var(--text-body); margin-top: 0.35rem; max-width: 680px; line-height: 1.5;">
              72-hour cold-fermented sourdough hand-stretched and ladled with San Marzano D.O.P. sauce.
            </p>
          </div>

          <!-- Big Digital Countdown Clock -->
          <div class="tracker-countdown-box">
            <div style="font-family: var(--font-mono); font-size: 0.72rem; color: var(--mozzarella-yellow); text-transform: uppercase; font-weight: 800; letter-spacing: 0.08em; margin-bottom: 2px;">
              EST. TIME REMAINING
            </div>
        ...
        <div>
          <div style="display: flex; justify-content: space-between; font-family: var(--font-mono); font-size: 0.74rem; color: var(--text-muted); font-weight: 700; margin-bottom: 0.45rem; text-transform: uppercase;">
            <span>Kitchen Pipeline Progress</span>
            <span style="color: var(--pizza-red); font-weight: 800;">Real-Time Dispatch</span>
          </div>
        ...
        <div class="kitchen-pipeline-grid">
          <div id="pipeline-stage-1" class="pipeline-stage-card active">
            ...
            <h4 class="pipeline-stage-title">Impasto Tossed</h4>
            <p style="font-size: 0.74rem; color: var(--text-muted); margin-top: 2px;">Hand stretched sourdough</p>
          </div>
          ...
          <div id="pipeline-stage-2" class="pipeline-stage-card">
            ...
            <p style="font-size: 0.74rem; color: var(--text-muted); margin-top: 2px;">San Marzano &amp; Fior di Latte</p>
          </div>
          ...
          <div id="pipeline-stage-3" class="pipeline-stage-card">
            ...
            <p style="font-size: 0.74rem; color: var(--text-muted); margin-top: 2px;">865°F White Oak Deck</p>
          </div>
          ...
          <div id="pipeline-stage-4" class="pipeline-stage-card">
            ...
            <p style="font-size: 0.74rem; color: var(--text-muted); margin-top: 2px;">Sliced, boxed &amp; hot</p>
          </div>
        </div>

      </section>

      <!-- Expansive 2-Column Split: Telemetry & Itemized Guest Receipt -->
      <section class="tracker-details-split">
        ...
        <div class="telemetry-panel-box">
          <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid var(--border-light); padding-bottom: 0.85rem; margin-bottom: 1rem;">
            <div style="display: flex; align-items: gap: 0.5rem;">
              <span style="font-size: 1.3rem;">🪵</span>
              <h3>Hearth Deck Telemetry</h3>
            </div>
            <span class="badge" style="background: var(--basil-green-light); color: var(--basil-green-dark); font-family: var(--font-mono); font-size: 0.72rem; font-weight: 800; padding: 0.25rem 0.65rem; border-radius: var(--radius-pill);">
              865°F OVEN LIVE
            </span>
          ...
          <p style="font-size: 0.86rem; color: var(--text-body); line-height: 1.55;">
            Our stone oven operates with kiln-dried Adirondack white oak and sugar maple, maintaining an exact 865°F stone deck temperature for authentic Neapolitan blistering and leopard crust charring.
          </p>

          <div class="telemetry-grid">
            <div class="telemetry-metric-tile">
              <span class="telemetry-label">Stone Deck Temp</span>
              <span class="telemetry-val" style="color: var(--pizza-red);">865°F Verified</span>
            </div>
            <div class="telemetry-metric-tile">
            ...
            <div class="telemetry-metric-tile">
              <span class="telemetry-label">Pickup Destination</span>
              <span id="tracker-pickup-destination-label" class="telemetry-val" style="color: var(--basil-green-dark);">Store Shelf #B-04</span>
            </div>
            <div class="telemetry-metric-tile">
              <span class="telemetry-label">Pizzaiolo On Duty</span>
              <span class="telemetry-val">Marco Bellini</span>
            </div>
          </div>

          <!-- Fast Forward Simulation Control -->
          <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid var(--border-light); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.75rem;">
            <div style="font-size: 0.76rem; color: var(--text-muted); font-family: var(--font-mono);">
              Simulate kitchen speed progression:
            </div>
            <button onclick="window.triggerSpeedBoost()" class="btn-secondary" style="font-size: 0.76rem; padding: 0.4rem 0.95rem;">
              ⚡ Fast-Forward Step (+4m)
            </button>
          </div>
        </div>

        <!-- RIGHT: Authentic Off-White Guest Check (Receipt) -->
        <div class="receipt-box">
          <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid var(--ticket-border); padding-bottom: 0.85rem; margin-bottom: 0.85rem;">
            <div>
              <div style="font-family: var(--font-mono); font-size: 0.68rem; color: var(--text-muted); text-transform: uppercase; font-weight: 800; letter-spacing: 0.08em;">
                OFFICIAL GUEST CHECK
              </div>
              <h3>Order Breakdown</h3>
            </div>
            <button onclick="window.showMenuSelectionView()" class="btn-secondary" style="font-size: 0.72rem; padding: 0.35rem 0.75rem;">
              <i class="fa-solid fa-plus"></i> Add Items
            </button>
          </div>

          <!-- Receipt Items List Container -->
          <div id="tracker-receipt-items-list" style="margin-bottom: 0.85rem;">
          ...
          <div class="receipt-totals-section">
            ...
            <div style="display: flex; justify-content: space-between; color: var(--text-muted);">
              <span>Pizzaiolo Gratuity (20%):</span>
          ...
          <div style="margin-top: 1.5rem; display: flex; flex-direction: column; gap: 0.6rem;">
            <button onclick="window.showMenuSelectionView()" class="btn-primary" style="width: 100%; justify-content: center; padding: 0.75rem;">
              <i class="fa-solid fa-utensils"></i> Back to Menu App
            </button>
            <button onclick="window.resetOrder()" class="btn-secondary" style="width: 100%; justify-content: center; color: var(--pizza-red); padding: 0.75rem;">
