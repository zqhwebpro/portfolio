$(function () { // document ready
  ...
  // navSlide event
  const navSlide = () => {
    const e = document.querySelector(".nav-burger-wrap"),
      i = document.querySelector(".container-nav"),
      t = document.querySelector(".filtr-container");
    e.addEventListener("click", () => {
      i.classList.toggle("nav-burger-hide"), t.classList.toggle("filtr-container-hide")
    })
  };
  // check window width for action
  function checkWidth() {
    $(window).width() >= 715 && ($(".container-nav").removeClass("nav-burger-hide"), $(".filtr-container").removeClass("filtr-container-hide"))
  }
  navSlide(), $(window).resize(checkWidth), $(function () {
    $(".lazy").lazy({
  ...
  $(document).on('click', '.all-button', function (e) {
    $('.dropdown-item').removeClass("activated");
    $('#btn-herb').html('HERBS + OILS');
    $('#btn-symp').html('SYMPTOMS');
    var e = $.Event("keyup", { keyCode: 13 } );
    $("#clear-prompt").val('').trigger(e);
    $("#clear-prompt").attr("placeholder" , "SEARCH...");
  });
  $('#btn-herb').click(function () {
    $('#btn-symp').html('SYMPTOMS');
    var e = $.Event("keyup", { keyCode: 13 } );
    $("#clear-prompt").val('').trigger(e);
    $("#clear-prompt").attr("placeholder" , "SEARCH...");
  });
  $('#btn-symp').click(function () {
    $('#btn-herb').html('HERBS + OILS');
    var e = $.Event("keyup", { keyCode: 13 } );
    $("#clear-prompt").val('').trigger(e);
    $("#clear-prompt").attr("placeholder" , "SEARCH...");
