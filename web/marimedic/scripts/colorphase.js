...
/* Color Animation, Waypoints, Transitions */

$(document).ready(function() {

    $("#sect_phase2").waypoint(function(event, direction) {
       if (direction === 'down') {
          $("body").animate({backgroundColor: 'rgba(52,81,70,0.85)'},1000)
       }
       else {
          $("body").animate({backgroundColor: 'rgba(31,53,47,1)'},1000)
       }
    });

    $("#sect_phase3").waypoint(function(event, direction) {
       if (direction === 'down') {
          $("body").animate({backgroundColor: 'rgba(130,140,81,0.85)'},1000)
       }
       else {
          $("body").animate({backgroundColor: 'rgba(52,81,70,0.85)'},1000)
       }
    ...
    $("#sect_phase4").waypoint(function(event, direction) {
       if (direction === 'down') {
          $("body").animate({backgroundColor: 'rgba(52,81,70,0.85)'},1000)
       }
       else {
