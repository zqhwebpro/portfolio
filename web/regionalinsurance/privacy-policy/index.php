...
<head>
	...
	<meta name="description" content="Want to make sure you're information is private? Read details about how we protect you in our privacy policy." />

	<title>Privacy Policy | Regional Insurance Associates</title>
	<script>
...
<div class="subpage-banners">
	<div class="container padding-vertical-lg">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="subpage-headline">Privacy Policy</h1>
			</div>
		</div>
	</div>
</div>
<div class="container">
	<div class="row">
         <div class="col-xs-12">
            ...
            <p class="privacy-special">• To follow up with them after correspondence (live chat, email or phone inquiries) I would make it you.</p>
            ...
            <p class="privacy-special">• We do not need an SSL because: Only name and contact information is transmitted.</p>
            ...
            <p class="privacy-special">• Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf.</p>
            ...
            <ul class="privacy-bullets">You can change your personal information:
                <li>By emailing us</li>
                <li>By calling us</li>
                <li>By mailing us</li>
            </ul>
            <p>Or in person at, Mechanicsville, VA 23111</p>
            ...
            <p class="privacy-special">• Send information, respond to inquiries, and/or other requests or questions</p>
            <h5>To be in accordance with the CAN-SPAM Act, we agree to the following:</h5>
          ...
          <p>If at any time you would like to unsubscribe from receiving future emails, you can email us at <a href="mailto:amockaitis@regionalinsurance.net">amockaitis@regionalinsurance.net</a> and we will promptly remove you from ALL correspondence.</p>
          <h5>Contacting Us</h5>
          <p>If there are any questions regarding this privacy policy, you may contact us using the information below.</p>
          <a href="http://regionalinsurance.net/" class="privacy-policy-link">http://regionalinsurance.net/</a><br/>
          <a href="mailto:amockaitis@regionalinsurance.net" class="privacy-policy-link">amockaitis@regionalinsurance.net</a>
          <p>Washington Crossing, PA 18977, United States<br/>

          <a href="tel:2153211900">215-321-1900</a><br/><br/>
          Last Edited on 2017-11-07</p>
        </div>
    </div>
</div>
