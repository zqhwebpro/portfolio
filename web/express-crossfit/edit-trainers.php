			...
			<div class="group">
				<div class="grid_6_of_6">
					...
					<form action="%3C?php%20echo%20$_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];?%3E" class="ec_form" method="post">
						...
						<div>
							<label for="imageid">Image ID:</label> <input class="" name="imageid" type="text" value="<?php echo $row['imageid'];?>">
						</div>
						<div>
							<label for="name">Name:</label> <input class="" name="name" type="text" value="<?php echo $row['name'];?>">
						</div>
						<div>
							<label for="phone">Phone:</label> <input class="" name="phone" type="text" value="<?php echo $row['phone'];?>">
						</div>
						<div>
							<label for="rate">Rate:</label> <input class="" name="rates" type="text" value="<?php echo $row['rates'];?>">
						</div>
						<div>
							<label for="trainerbio">Trainer Bio:</label> <input class="" name="trainerbio" type="text" value="<?php echo $row['trainerbio'];?>">
						</div>
						<div>
							<label for="trainerid">Trainer ID:</label> <input class="" name="trainerid" type="text" value="<?php echo $row['trainerid'];?>">
						</div>
						<div>
