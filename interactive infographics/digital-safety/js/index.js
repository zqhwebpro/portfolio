/**
 * Digital Safety - Landing Page & Responsive Viewport Controller
 * -------------------------------------------------------------
 * Manages CTA navigation buttons to the Guide and Quiz, and handles responsive
 * layout adjustments across various screen heights and widths (iPad Pro, desktop, mobile).
 */
...
$(document).ready(function () {
    ...
    function applyResponsiveLayout() {
        ...
        if (window.matchMedia('(height: 768px)').matches) {
            ...
            $('.category-wrap .inner-wrap').css({ height: '100%', width: '100%' });
    ...
    // Apply on initial load and window resize
    applyResponsiveLayout();
    $(window).on('resize', applyResponsiveLayout);
});
